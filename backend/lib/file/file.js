...
var File = /** @class */ (function () {
    ...
    ;
    File.prototype.saveToDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, connection.query('INSERT INTO files VALUES (?, ?, ?, ?, ?)', [this.fileId, this.fileName, this.fileSize])];
                    case 3:
