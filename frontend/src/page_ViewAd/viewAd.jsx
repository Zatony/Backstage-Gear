      ...
      <div className={viewAd.adCardColumn}>
        <div className={viewAd.adInfoBlock}>
          <div className={viewAd.adImageAndUser}>
            <img src={getAd.files} alt={getAd.item_name} className={viewAd.mainImg} />
               <div className={viewAd.userRow}>
                 <img className={viewAd.userIcon} src={userData.profile_picture} alt={userData.username} />
                 <span className={viewAd.username}>{userData.username}</span>
               </div>
               <div className={viewAd.ratingRow}>
                 <span className={viewAd.rating}>{`Értékelés: +${userData.up_votes} | -${userData.down_votes}`}</span>
               </div>
          </div>
        ...
        <div className={viewAd.priceButtonsFullWidth}>
          <span className={viewAd.price}>
            {getAd.price !== undefined && getAd.price !== null ? getAd.price.toLocaleString("hu-HU") : "-"} Ft
          </span>
          <div className={viewAd.buttonRow}>
            ...
            {!isMyAd && (
              <>
                <button onClick={handleReport} className={viewAd.reportBtn}>Hirdetés jelentése</button>
